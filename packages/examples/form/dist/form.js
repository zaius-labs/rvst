var zt = Array.isArray, Vt = Array.prototype.indexOf, ue = Array.prototype.includes, Ht = Array.from, Ut = Object.defineProperty, de = Object.getOwnPropertyDescriptor, Bt = Object.prototype, $t = Array.prototype, Kt = Object.getPrototypeOf, Ge = Object.isExtensible;
const Gt = () => {
};
function Wt(e) {
...
const b = 2, we = 4, Ne = 8, at = 1 << 24, Z = 16, W = 32, ne = 64, Ie = 128, R = 512, y = 1024, S = 2048, L = 4096, $ = 8192, I = 16384, he = 32768, We = 1 << 25, ke = 65536, Ze = 1 << 17, Zt = 1 << 18, _e = 1 << 19, Jt = 1 << 20, re = 65536, je = 1 << 21, qe = 1 << 22, K = 1 << 23, Fe = Symbol("$state"), V = new class extends Error {
...
function dt(e, t, n) {
  (e.f & S) !== 0 ? t.add(e) : (e.f & L) !== 0 && n.add(e), vt(e.deps), m(e, y);
}
const H = /* @__PURE__ */ new Set();
let g = null, F = null, Le = null, pe = !1, Pe = !1, le = null, xe = null;
var Je = 0;
let hn = 1;
class ie {
  id = hn++;
  ...
  #h() {
    if (Je++ > 1e3 && (H.delete(this), vn()), !this.#c()) {
  ...
  #a(t, n, r) {
    ...
    for (var i = t.first; i !== null; ) {
      var s = i.f, a = (s & (W | ne)) !== 0, f = a && (s & y) !== 0, u = f || (s & $) !== 0 || this.#s.has(i);
      if (!u && i.fn !== null) {
  ...
  flush() {
    try {
      ...
      Je = 0, Le = null, le = null, xe = null, Pe = !1, g = null, F = null, G.clear();
    }
  }
  discard() {
...
function Qe(e) {
  ...
  if (t !== 0) {
    for (var n = 0; n < t; ) {
      var r = e[n++];
      if ((r.f & (I | $)) === 0 && ye(r) && (z = /* @__PURE__ */ new Set(), ce(r), r.deps === null && r.first === null && r.nodes === null && r.teardown === null && r.ac === null && Ft(r), z?.size > 0)) {
        G.clear();
        for (const i of z) {
          if ((i.f & (I | $)) !== 0) continue;
          const s = [i];
  ...
  if (!n.has(e) && (n.add(e), e.reactions !== null))
    for (const i of e.reactions) {
      ...
      (s & b) !== 0 ? pt(
        ...
        n,
        r
      ) : (s & (qe | Z)) !== 0 && (s & S) === 0 && gt(i, t, r) && (m(i, S), Ve(
        /** @type {Effect} */
        i
      ));
    }
...
function mn(e, t, n, r) {
  ...
  var o = yt();
  function h() {
    Promise.all(n.map((c) => /* @__PURE__ */ En(c))).then((c) => l([...t.map(i), ...c])).catch((c) => B(c, a)).finally(() => o());
  }
  u ? u.then(() => {
    f(), h(), Ae();
  }) : h();
...
function yn() {
  ...
  return function(s = !0) {
    Y(e), O(t), ae(n), s && (e.f & I) === 0 && (r?.activate(), r?.apply());
  };
}
function Ae(e = !0) {
  Y(null), O(null), ae(null), e && g?.deactivate();
}
function yt() {
  var e = (
    /** @type {Effect} */
...
function bt(e) {
  ...
  oe || (F !== null ? ($e() || g?.is_fork) && F.set(e, n) : ze(e));
}
function Sn(e) {
  if (e.effects !== null)
    for (const t of e.effects)
      (t.teardown || t.ac) && (t.teardown?.(), t.ac?.abort(V), t.teardown = Gt, t.ac = null, me(t, 0), Ke(t));
}
function Et(e) {
  if (e.effects !== null)
    for (const t of e.effects)
...
function U(e, t, n = !1) {
  ...
  (!P || (d.f & Ze) !== 0) && ct() && (d.f & (b | Z | qe | Ze)) !== 0 && (N === null || !ue.call(N, e)) && nn();
  let r = n ? ve(t) : t;
  return Re(e, r, xe);
}
function Re(e, t, n = null) {
  if (!e.equals(t)) {
    ...
    if (i.capture(e, r), (e.f & b) !== 0) {
      ...
      (e.f & S) !== 0 && He(s), F === null && ze(s);
    }
    e.wv = Ct(), Tt(e, S, n), p !== null && (p.f & y) !== 0 && (p.f & (W | ne)) === 0 && (A === null ? Hn([e]) : A.push(e)), !i.is_fork && Ye.size > 0 && !xt && kn();
  }
  return t;
}
function kn() {
  ...
  if (r !== null)
    for (var i = r.length, s = 0; s < i; s++) {
      ...
      if (u && m(a, t), (f & b) !== 0) {
        ...
        F?.delete(l), (f & re) === 0 && (f & R && (a.f |= re), Tt(l, L, n));
      } else if (u) {
        var o = (
          /** @type {Effect} */
          a
        );
        (f & Z) !== 0 && z !== null && z.add(o), n !== null ? n.push(o) : Ve(o);
      }
    }
}
function ve(e) {
    ...
    e,
    {
      ...
      set(f, u, l, o) {
        ...
        if (r && u === "length")
          ...
          h.v; v += 1) {
            var _ = n.get(v + "");
            _ !== void 0 ? U(_, E) : v in f && (_ = a(() => /* @__PURE__ */ q(E)), n.set(v + "", _));
          }
        if (h === void 0)
          (!c || de(f, u)?.writable) && (h = a(() => /* @__PURE__ */ q(void 0)), U(h, ve(l)), n.set(u, h));
        else {
          c = h.v !== E;
          var w = a(() => ve(l));
          U(h, w);
...
function An() {
  if (Xe === void 0) {
    ...
    kt = de(t, "firstChild").get, At = de(t, "nextSibling").get, Ge(e) && (e.__click = void 0, e.__className = void 0, e.__attributes = null, e.__style = void 0, e.__e = void 0), Ge(n) && (n.__t = void 0);
  }
}
function Rt(e = "") {
...
function J(e, t) {
  ...
  if (i !== null && (i.parent = n, n !== null && Fn(i, n), d !== null && (d.f & b) !== 0 && (e & ne) === 0)) {
    var s = (
      /** @type {Derived} */
      d
    );
...
function jt(e) {
  var t = T, n = k, r = A, i = d, s = N, a = M, f = P, u = te, l = e.f;
  T = /** @type {null | Value[]} */
  null, k = 0, A = null, d = (l & (W | ne)) === 0 ? e : null, N = null, ae(e.ctx), P = !1, te = ++ee, e.ac !== null && (Be(() => {
    e.ac.abort(V);
  }), e.ac = null);
  try {
    e.f |= je;
    ...
    if (ct() && A !== null && !P && c !== null && (e.f & (b | L | S)) === 0)
    ...
    e.f ^= je, T = t, k = n, A = r, d = i, N = s, ae(a), P = f, te = u;
  }
}
function Un(e, t) {
  let n = t.reactions;
...
function C(e) {
  ...
  if (n) {
    ...
    if (oe) {
      var f = a.v;
      return ((a.f & y) === 0 && a.reactions !== null || Yt(a)) && (f = He(a)), G.set(a, f), f;
    }
    var u = (a.f & R) === 0 && !P && d !== null && (Se || (d.f & R) !== 0), l = (a.f & he) === 0;
...
function lr(e, t, n = t) {
  ...
  Dn(e, "input", async (i) => {
    ...
    if (s = Me(e) ? Ce(s) : s, n(s), g !== null && r.add(g), await Bn(), s !== (s = t())) {
  ...
  qt(t) == null && e.value && (n(Me(e) ? Ce(e.value) : e.value), g !== null && r.add(g)), Ot(() => {
    var i = t();
...
var fr = /* @__PURE__ */ tr('<div><input placeholder="Your name"/> <span> </span></div>');
function ur(e) {
  let t = /* @__PURE__ */ q("");
  var n = fr(), r = et(n), i = Rn(r, 2), s = et(i);
  jn(() => Kn(s, C(t) ? `Hello, ${C(t)}!` : "Enter your name")), lr(r, () => C(t), (a) => U(t, a)), nr(e, n);
}
function or(e) {
