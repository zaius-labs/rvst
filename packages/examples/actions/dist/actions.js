var Lt = Array.isArray, qt = Array.prototype.indexOf, ue = Array.prototype.includes, Yt = Array.from, zt = Object.defineProperty, ge = Object.getOwnPropertyDescriptor, Ut = Object.prototype, Vt = Array.prototype, $t = Object.getPrototypeOf, Ke = Object.isExtensible;
const Bt = () => {
};
function Ht(e) {
...
const b = 2, ae = 4, Re = 8, lt = 1 << 24, J = 16, Z = 32, te = 64, Pe = 128, R = 512, y = 1024, k = 2048, Y = 4096, K = 8192, L = 16384, de = 32768, Ge = 1 << 25, ke = 65536, We = 1 << 17, Kt = 1 << 18, _e = 1 << 19, Gt = 1 << 20, ne = 65536, Ie = 1 << 21, Ye = 1 << 22, G = 1 << 23, De = Symbol("$state"), V = new class extends Error {
...
class re {
  ...
  #h() {
    if (Ze++ > 1e3 && (B.delete(this), on()), !this.#c()) {
    ...
    if (le = null, Ee = null, this.#c() || this.#_()) {
      this.#v(r), this.#v(n);
  ...
  #a(t, n, r) {
    ...
    for (var i = t.first; i !== null; ) {
      var s = i.f, a = (s & (Z | te)) !== 0, u = a && (s & y) !== 0, f = u || (s & K) !== 0 || this.#s.has(i);
      if (!f && i.fn !== null) {
        a ? i.f ^= y : (s & ae) !== 0 ? n.push(i) : ye(i) && ((s & J) !== 0 && this.#n.add(i), he(i));
        var l = i.first;
        if (l !== null) {
          i = l;
          continue;
  ...
  flush() {
    try {
      ...
      Ze = 0, je = null, le = null, Ee = null, Fe = !1, w = null, F = null, W.clear();
    }
  }
  discard() {
   ...
   */
  schedule(t) {
    if (je = t, t.b?.is_pending && (t.f & (ae | Re | lt)) !== 0 && (t.f & de) === 0) {
      t.b.defer_effect(t);
      return;
    }
...
function Je(e) {
  ...
  if (t !== 0) {
    for (var n = 0; n < t; ) {
      var r = e[n++];
      if ((r.f & (L | K)) === 0 && ye(r) && (U = /* @__PURE__ */ new Set(), he(r), r.deps === null && r.first === null && r.nodes === null && r.teardown === null && r.ac === null && Rt(r), U?.size > 0)) {
        W.clear();
        for (const i of U) {
  ...
  if (!n.has(e) && (n.add(e), e.reactions !== null))
    for (const i of e.reactions) {
      ...
      (s & b) !== 0 ? ht(
        ...
        n,
        r
      ) : (s & (Ye | J)) !== 0 && (s & k) === 0 && dt(i, t, r) && (m(i, k), Ue(
        /** @type {Effect} */
        i
      ));
    }
...
function gt(e) {
  ...
  ce || (F !== null ? (Be() || w?.is_fork) && F.set(e, n) : ze(e));
}
function bn(e) {
  if (e.effects !== null)
    for (const t of e.effects)
      (t.teardown || t.ac) && (t.teardown?.(), t.ac?.abort(V), t.teardown = Bt, t.ac = null, me(t, 0), He(t));
}
function wt(e) {
  if (e.effects !== null)
    for (const t of e.effects)
...
function I(e, t, n = !1) {
  ...
  (!M || (v.f & We) !== 0) && ut() && (v.f & (b | J | Ye | We)) !== 0 && (N === null || !ue.call(N, e)) && Xt();
  let r = n ? ve(t) : t;
  return Ae(e, r, Ee);
}
function Ae(e, t, n = null) {
  if (!e.equals(t)) {
    ...
    if (i.capture(e, r), (e.f & b) !== 0) {
      ...
      (e.f & k) !== 0 && Ve(s), F === null && ze(s);
    }
    e.wv = Dt(), yt(e, k, n), p !== null && (p.f & y) !== 0 && (p.f & (Z | te)) === 0 && (A === null ? Ln([e]) : A.push(e)), !i.is_fork && Le.size > 0 && !mt && En();
  }
  return t;
}
function En() {
  ...
  if (r !== null)
    for (var i = r.length, s = 0; s < i; s++) {
      ...
      if (f && m(a, t), (u & b) !== 0) {
        ...
        F?.delete(l), (u & ne) === 0 && (u & R && (a.f |= ne), yt(l, Y, n));
      } else if (f) {
        var o = (
          /** @type {Effect} */
          a
        );
        (u & J) !== 0 && U !== null && U.add(o), n !== null ? n.push(o) : Ue(o);
      }
    }
}
function ve(e) {
  ...
  if (t !== Ut && t !== Vt)
    return e;
  var n = /* @__PURE__ */ new Map(), r = Lt(e), i = /* @__PURE__ */ P(0), s = ee, a = (u) => {
    if (ee === s)
      return u();
    var f = v, l = ee;
    O(null), et(s);
    ...
    e,
    {
      ...
      get(u, f, l) {
        ...
        if (o === void 0 && (!h || ge(u, f)?.writable) && (o = a(() => {
          var _ = ve(h ? u[f] : E), d = /* @__PURE__ */ P(_);
          return d;
        }), n.set(f, o)), o !== void 0) {
          var c = j(o);
          return c === E ? void 0 : c;
      ...
      has(u, f) {
        ...
        if (l !== void 0 || p !== null && (!o || ge(u, f)?.writable)) {
          l === void 0 && (l = a(() => {
            var c = o ? ve(u[f]) : E, _ = /* @__PURE__ */ P(c);
            return _;
          }), n.set(f, l));
          var h = j(l);
          if (h === E)
      ...
      set(u, f, l, o) {
        ...
        if (r && f === "length")
          ...
          h.v; _ += 1) {
            var d = n.get(_ + "");
            d !== void 0 ? I(d, E) : _ in u && (d = a(() => /* @__PURE__ */ P(E)), n.set(_ + "", d));
          }
        if (h === void 0)
          (!c || ge(u, f)?.writable) && (h = a(() => /* @__PURE__ */ P(void 0)), I(h, ve(l)), n.set(f, h));
        else {
          c = h.v !== E;
          var g = a(() => ve(l));
          I(h, g);
        ...
        if (x?.set && x.set.call(o, l), !c) {
          if (r && typeof f == "string") {
            ...
            Number.isInteger(ie) && ie >= D.v && I(D, ie + 1);
          }
          we(i);
        }
        return !0;
...
function xn() {
  if (Qe === void 0) {
    Qe = window, bt = /Firefox/.test(navigator.userAgent);
    var e = Element.prototype, t = Node.prototype, n = Text.prototype;
    Et = ge(t, "firstChild").get, xt = ge(t, "nextSibling").get, Ke(e) && (e.__click = void 0, e.__className = void 0, e.__attributes = null, e.__style = void 0, e.__e = void 0), Ke(n) && (n.__t = void 0);
  }
}
function Tt(e = "") {
...
function $(e, t) {
  ...
  if ((e & ae) !== 0)
    ...
    (i.f & _e) === 0 && (i = i.first, (e & J) !== 0 && (e & ke) !== 0 && i !== null && (i.f |= ke));
  }
...
function Mt(e) {
  ...
  T = /** @type {null | Value[]} */
  null, S = 0, A = null, v = (l & (Z | te)) === 0 ? e : null, N = null, oe(e.ctx), M = !1, ee = ++X, e.ac !== null && (St(() => {
    e.ac.abort(V);
  }), e.ac = null);
  try {
    e.f |= Ie;
    ...
    } else !_ && c !== null && S < c.length && (me(e, S), c.length = S);
    ...
    e.f ^= Ie, T = t, S = n, A = r, v = i, N = s, oe(a), M = u, ee = f;
  }
}
function qn(e, t) {
  let n = t.reactions;
  ...
  (T === null || !ue.call(T, t))) {
    ...
    (s.f & R) !== 0 && (s.f ^= R, s.f &= ~ne), ze(s), bn(s), me(s, 0);
  }
}
function me(e, t) {
  var n = e.deps;
...
function j(e) {
  ...
  if (n) {
    ...
    if (ce) {
      var u = a.v;
      return ((a.f & y) === 0 && a.reactions !== null || Pt(a)) && (u = Ve(a)), W.set(a, u), u;
    }
    var f = (a.f & R) === 0 && !M && v !== null && (Te || (v.f & R) !== 0), l = (a.f & de) === 0;
...
const pe = Symbol("events"), jt = /* @__PURE__ */ new Set(), qe = /* @__PURE__ */ new Set();
function Vn(e, t, n) {
  (t[pe] ??= {})[e] = n;
}
function $n(e) {
    ...
    return c(Yt(jt)), qe.add(c), () => {
      for (var _ of h)
        for (const x of [t, document]) {
          ...
          --g == 0 ? (x.removeEventListener(_, it), d.delete(_), d.size === 0 && be.delete(x)) : d.set(_, g);
        }
...
var tr = /* @__PURE__ */ Wn('<div><span data-testid="target">Target</span> <div> </div> <button>Toggle</button> <div> </div></div>');
function nr(e) {
  let t = /* @__PURE__ */ P(!1), n = /* @__PURE__ */ P(!1);
  function r(h) {
    return h.setAttribute("data-marked", "true"), I(n, !0), {
      destroy() {
        h.removeAttribute("data-marked"), I(n, !1);
      }
    };
  }
  var i = tr(), s = Me(i);
  er(s, (h) => r?.(h));
  var a = Ce(s, 2), u = Me(a), f = Ce(a, 2), l = Ce(f, 2), o = Me(l);
  Fn(() => {
    nt(u, `Marked: ${j(n) ?? ""}`), nt(o, `Active: ${j(t) ?? ""}`);
  }), Vn("click", f, () => I(t, !j(t))), Zn(e, i);
}
$n(["click"]);
function ir(e) {
